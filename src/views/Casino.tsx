            ...
            <div className="max-w-[1500px] w-full h-auto mx-auto flex items-center gap-x-10 mt-10 lg:flex-row flex-col">
                ...
                <RightLeft>
                    <div className="w-full h-full">
                        <h1 className="text-4xl font-nexa">VRAI <span className="text-lavender drop-shadow-road">CASINO</span></h1>
                        ...
                        <div className="flex flex-col mt-3 gap-y-8 max-w-[40rem] font-regular">
                            ...
                            <p className="">
                                <span className="font-bold">But it's not</span> just about winning big - it's also about having fun. That's why VRAI gamemode casino has a lively and engaging environment, where players can enjoy themselves in addition to the thrilling games. The casino's graphic design and user interface are top-notch, providing a seamless and immersive experience for players.
                            </p>

                            <p className="">
                                <span className="font-bold">In conclusion</span> , the VRAI gamemode casino provides players with an exciting and immersive gaming experience. Through a variety of custom-made games and a well-designed user interface, players of all skill levels can enjoy themselves while gambling in a safe and controlled environment.
                            </p>
                        </div>
                    </div>
                </RightLeft>
